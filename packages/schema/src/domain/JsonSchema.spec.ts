...
describe("JsonSchema", () => {
  describe('set()', () => {
    it("should validate declare a model", () => {
      const jsonSchema = JsonSchema.from({})
      jsonSchema.set('unknown', true)
  ...
  describe("basics", () => {
    ...
    it("should validate {}", () => {
      ...
      expect(jsonSchema.isCollection).to.equal(false);
      expect(jsonSchema.isRequired("any")).to.equal(false);
      expect(schema).to.deep.equal({});
