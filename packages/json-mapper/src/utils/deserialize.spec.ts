...
import {OnDeserialize, deserialize} from "@tsed/json-mapper";
...
describe("deserialize()", () => {
  ...
  describe("Array<Model>", () => {
    ...
    it("should transform an array of string (array parameter)", () => {
      // WHEN
      class Controller {
        @OperationPath("POST", "/")
        async method(@In("body") @CollectionOf(String) any: string[]) {
          return null;
        }
      }
    ...
    it("should transform an array of string (array parameter + name)", () => {
      // WHEN
      class Controller {
        @OperationPath("POST", "/")
        async method(@In("body") @Name('keys') @CollectionOf(String) any: string[]) {
          return null;
        }
      }
